...
+ (id)resizeToIdealSizeWithData:(id)arg1 originSize:(struct CGSize)arg2 size:(struct CGSize)arg3 shouldCrop:(unsigned char)arg4;
+ (id)resizeToIdealSizeWithData:(id)arg1 size:(struct CGSize)arg2 shouldCrop:(unsigned char)arg3;
